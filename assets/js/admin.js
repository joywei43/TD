(function(){
  ...
  async function renderDisplaySettings(){
    ...
    $('#logoStatus').textContent=(await EverestStore.loadBlob('logo'))?'Custom logo saved':'No custom logo';$('#backgroundStatus').textContent=(await EverestStore.loadBlob('background'))?'Custom background saved':'Default background';
  }
